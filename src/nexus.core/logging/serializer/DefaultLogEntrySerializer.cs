...
namespace nexus.core.logging.serializer
{
   ...
   public class DefaultLogEntrySerializer : ILogEntrySerializer
   {
      ...
      /// <summary>
      /// If true, any <see cref="IStackFrame" /> attached to the log entry will be emitted to the serialized string
      /// </summary>
      public Boolean DisplayContextIfAttached { get; set; }
      ...
      public virtual String Serialize( ILogEntry entry )
      {
         ...
         var origin = "";
         if(DisplayContextIfAttached)
         {
            origin = IfAttached<IStackFrame>(
               entry,
